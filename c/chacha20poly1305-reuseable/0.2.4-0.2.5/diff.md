# Comparing `tmp/chacha20poly1305_reuseable-0.2.4.tar.gz` & `tmp/chacha20poly1305_reuseable-0.2.5.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "chacha20poly1305_reuseable-0.2.4.tar", max compression
+gzip compressed data, was "chacha20poly1305_reuseable-0.2.5.tar", max compression
```

## Comparing `chacha20poly1305_reuseable-0.2.4.tar` & `chacha20poly1305_reuseable-0.2.5.tar`

### file list

```diff
@@ -1,9 +1,9 @@
--rw-r--r--   0        0        0    12880 2023-04-28 02:05:36.673797 chacha20poly1305_reuseable-0.2.4/LICENSE
--rw-r--r--   0        0        0     4027 2023-04-28 02:05:36.673797 chacha20poly1305_reuseable-0.2.4/README.md
--rw-r--r--   0        0        0      905 2023-04-28 02:05:36.673797 chacha20poly1305_reuseable-0.2.4/build_ext.py
--rw-r--r--   0        0        0     2131 2023-04-28 02:05:37.593800 chacha20poly1305_reuseable-0.2.4/pyproject.toml
--rw-r--r--   0        0        0     1772 2023-04-28 02:05:36.673797 chacha20poly1305_reuseable-0.2.4/src/chacha20poly1305_reuseable/__init__.pxd
--rw-r--r--   0        0        0     8865 2023-04-28 02:05:37.561800 chacha20poly1305_reuseable-0.2.4/src/chacha20poly1305_reuseable/__init__.py
--rw-r--r--   0        0        0        0 2023-04-28 02:05:36.673797 chacha20poly1305_reuseable-0.2.4/src/chacha20poly1305_reuseable/py.typed
--rw-r--r--   0        0        0     4913 1970-01-01 00:00:00.000000 chacha20poly1305_reuseable-0.2.4/setup.py
--rw-r--r--   0        0        0     5263 1970-01-01 00:00:00.000000 chacha20poly1305_reuseable-0.2.4/PKG-INFO
...
### Comparing `chacha20poly1305_reuseable-0.2.4/LICENSE` & `chacha20poly1305_reuseable-0.2.5/LICENSE`

 * *Files identical despite different names*

### Comparing `chacha20poly1305_reuseable-0.2.4/README.md` & `chacha20poly1305_reuseable-0.2.5/README.md`

 * *Files identical despite different names*

### Comparing `chacha20poly1305_reuseable-0.2.4/build_ext.py` & `chacha20poly1305_reuseable-0.2.5/build_ext.py`

 * *Files identical despite different names*

### Comparing `chacha20poly1305_reuseable-0.2.4/pyproject.toml` & `chacha20poly1305_reuseable-0.2.5/pyproject.toml`
...
### Comparing `chacha20poly1305_reuseable-0.2.4/src/chacha20poly1305_reuseable/__init__.pxd` & `chacha20poly1305_reuseable-0.2.5/src/chacha20poly1305_reuseable/__init__.pxd`

 * *Files identical despite different names*

### Comparing `chacha20poly1305_reuseable-0.2.4/src/chacha20poly1305_reuseable/__init__.py` & `chacha20poly1305_reuseable-0.2.5/src/chacha20poly1305_reuseable/__init__.py`
...
### Comparing `chacha20poly1305_reuseable-0.2.4/setup.py` & `chacha20poly1305_reuseable-0.2.5/setup.py`
...
-'chacha20poly1305-reuseable', 'version': '0.2.4', 'description':
...
### Comparing `chacha20poly1305_reuseable-0.2.4/PKG-INFO` & `chacha20poly1305_reuseable-0.2.5/PKG-INFO`
...
```diff
@@ -1,8 +1,8 @@
-Metadata-Version: 2.1 Name: chacha20poly1305-reuseable Version: 0.2.4 Summary:
