# Comparing `tmp/custardpy-0.3.2-py3-none-any.whl.zip` & `tmp/custardpy-0.3.3-py3-none-any.whl.zip`
...
## Comparing `custardpy-0.3.2.data/scripts/InsulationScore.py` & `custardpy-0.3.3.data/scripts/InsulationScore.py`
