# Comparing `tmp/devtools-ai-0.1.37.tar.gz` & `tmp/devtools-ai-0.1.38.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "devtools-ai-0.1.37.tar", last modified: Thu Mar 23 01:18:56 2023, max compression
+gzip compressed data, was "devtools-ai-0.1.38.tar", last modified: Thu Apr 27 22:30:14 2023, max compression
```

## Comparing `devtools-ai-0.1.37.tar` & `devtools-ai-0.1.38.tar`

### file list

```diff
@@ -1,24 +1,24 @@
-drwxr-xr-x   0 chris      (501) staff       (20)        0 2023-03-23 01:18:56.338062 devtools-ai-0.1.37/
--rw-r--r--   0 chris      (501) staff       (20)     9143 2022-06-18 16:37:36.000000 devtools-ai-0.1.37/LICENSE.md
--rw-r--r--   0 chris      (501) staff       (20)     2776 2023-03-23 01:18:56.337656 devtools-ai-0.1.37/PKG-INFO
--rw-r--r--   0 chris      (501) staff       (20)     1773 2023-03-02 18:30:06.000000 devtools-ai-0.1.37/README.md
-drwxr-xr-x   0 chris      (501) staff       (20)        0 2023-03-23 01:18:56.332549 devtools-ai-0.1.37/devtools_ai/
--rw-r--r--   0 chris      (501) staff       (20)       21 2023-03-23 01:18:24.000000 devtools-ai-0.1.37/devtools_ai/__init__.py
--rw-r--r--   0 chris      (501) staff       (20)    11352 2023-03-23 01:17:59.000000 devtools-ai-0.1.37/devtools_ai/appium.py
--rw-r--r--   0 chris      (501) staff       (20)    24563 2023-03-11 06:45:01.000000 devtools-ai-0.1.37/devtools_ai/selenium.py
-drwxr-xr-x   0 chris      (501) staff       (20)        0 2023-03-23 01:18:56.337073 devtools-ai-0.1.37/devtools_ai/utils/
--rw-r--r--   0 chris      (501) staff       (20)        0 2022-06-18 16:37:36.000000 devtools-ai-0.1.37/devtools_ai/utils/__init__.py
--rw-r--r--   0 chris      (501) staff       (20)    10713 2023-02-13 00:24:21.000000 devtools-ai-0.1.37/devtools_ai/utils/local_classify.py
--rw-r--r--   0 chris      (501) staff       (20)      342 2023-03-11 06:45:01.000000 devtools-ai-0.1.37/devtools_ai/utils/misc.py
--rw-r--r--   0 chris      (501) staff       (20)     2637 2023-02-13 00:24:21.000000 devtools-ai-0.1.37/devtools_ai/utils/network_utils.py
--rw-r--r--   0 chris      (501) staff       (20)    10521 2022-08-05 19:01:02.000000 devtools-ai-0.1.37/devtools_ai/utils/scanner.py
--rw-r--r--   0 chris      (501) staff       (20)    31695 2023-03-22 01:14:20.000000 devtools-ai-0.1.37/devtools_ai/utils/selenium_core.py
-drwxr-xr-x   0 chris      (501) staff       (20)        0 2023-03-23 01:18:56.334668 devtools-ai-0.1.37/devtools_ai.egg-info/
--rw-r--r--   0 chris      (501) staff       (20)     2776 2023-03-23 01:18:56.000000 devtools-ai-0.1.37/devtools_ai.egg-info/PKG-INFO
--rw-r--r--   0 chris      (501) staff       (20)      479 2023-03-23 01:18:56.000000 devtools-ai-0.1.37/devtools_ai.egg-info/SOURCES.txt
--rw-r--r--   0 chris      (501) staff       (20)        1 2023-03-23 01:18:56.000000 devtools-ai-0.1.37/devtools_ai.egg-info/dependency_links.txt
--rw-r--r--   0 chris      (501) staff       (20)      103 2023-03-23 01:18:56.000000 devtools-ai-0.1.37/devtools_ai.egg-info/requires.txt
--rw-r--r--   0 chris      (501) staff       (20)       12 2023-03-23 01:18:56.000000 devtools-ai-0.1.37/devtools_ai.egg-info/top_level.txt
--rw-r--r--   0 chris      (501) staff       (20)      103 2022-06-18 16:37:36.000000 devtools-ai-0.1.37/pyproject.toml
--rw-r--r--   0 chris      (501) staff       (20)       38 2023-03-23 01:18:56.338189 devtools-ai-0.1.37/setup.cfg
--rw-r--r--   0 chris      (501) staff       (20)     1950 2023-02-13 00:24:21.000000 devtools-ai-0.1.37/setup.py
...
### Comparing `devtools-ai-0.1.37/LICENSE.md` & `devtools-ai-0.1.38/LICENSE.md`

 * *Files identical despite different names*

### Comparing `devtools-ai-0.1.37/PKG-INFO` & `devtools-ai-0.1.38/PKG-INFO`
...
### Comparing `devtools-ai-0.1.37/README.md` & `devtools-ai-0.1.38/README.md`

 * *Files identical despite different names*

### Comparing `devtools-ai-0.1.37/devtools_ai/appium.py` & `devtools-ai-0.1.38/devtools_ai/appium.py`
...
-                element = self._match_bounding_box_to_web_element(element_box, multiplier=self.multiplier, use_first=self.use_ai_elem)
                 if self.use_ai_elem:
-                    element = ai_elem(None, element._id, element_box, self.driver,
-                                      self.multiplier, smart_driver=self, base_elem=element)
...
+
             ...
             # Check results
             try:
                 stack_trace = collect_stack_trace()
                 data = {
@@ -119,17 +127,20 @@
...
-                element = self._match_bounding_box_to_web_element(element_box, multiplier=self.multiplier, use_first=self.use_ai_elem)
                 if self.use_ai_elem:
-                    element = ai_elem(None, elem_id, element_box, self.driver, self.multiplier, smart_driver=self, base_elem=element)
+                    root_elem = self._match_bounding_box_to_web_element(element_box, multiplier=self.multiplier, use_first=self.use_ai_elem)
+                    element = ai_elem(None, root_elem.id, element_box, self.driver, self.multiplier, smart_driver=self, base_elem=root_elem)
+                else:
+                    element = self._match_bounding_box_to_web_element(element_box, multiplier=self.multiplier, use_first=self.use_ai_elem)
+
             except Exception:
     ...
     def _match_bounding_box_to_web_element(self, bounding_box, multiplier=1, use_first=False):
         """
             We have to ba hacky about this becasue Selenium does not let us click by coordinates.
```

### Comparing `devtools-ai-0.1.37/devtools_ai/selenium.py` & `devtools-ai-0.1.38/devtools_ai/selenium.py`

 * *Files identical despite different names*

### Comparing `devtools-ai-0.1.37/devtools_ai/utils/local_classify.py` & `devtools-ai-0.1.38/devtools_ai/utils/local_classify.py`

 * *Files identical despite different names*

### Comparing `devtools-ai-0.1.37/devtools_ai/utils/network_utils.py` & `devtools-ai-0.1.38/devtools_ai/utils/network_utils.py`

 * *Files identical despite different names*

### Comparing `devtools-ai-0.1.37/devtools_ai/utils/scanner.py` & `devtools-ai-0.1.38/devtools_ai/utils/scanner.py`

 * *Files identical despite different names*

### Comparing `devtools-ai-0.1.37/devtools_ai/utils/selenium_core.py` & `devtools-ai-0.1.38/devtools_ai/utils/selenium_core.py`

 * *Files identical despite different names*

### Comparing `devtools-ai-0.1.37/devtools_ai.egg-info/PKG-INFO` & `devtools-ai-0.1.38/devtools_ai.egg-info/PKG-INFO`
...
### Comparing `devtools-ai-0.1.37/setup.py` & `devtools-ai-0.1.38/setup.py`
