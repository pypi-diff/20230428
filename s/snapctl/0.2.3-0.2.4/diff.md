# Comparing `tmp/snapctl-0.2.3.tar.gz` & `tmp/snapctl-0.2.4.tar.gz`
...
## Comparing `snapctl-0.2.3.tar` & `snapctl-0.2.4.tar`
...
### Comparing `snapctl-0.2.3/snapctl/commands/byosnap.py` & `snapctl-0.2.4/snapctl/commands/byosnap.py`
...
### Comparing `snapctl-0.2.3/snapctl/main.py` & `snapctl-0.2.4/snapctl/main.py`

 * *Files identical despite different names*

### Comparing `snapctl-0.2.3/PKG-INFO` & `snapctl-0.2.4/PKG-INFO`
