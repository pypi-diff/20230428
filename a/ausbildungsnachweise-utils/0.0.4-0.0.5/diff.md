# Comparing `tmp/ausbildungsnachweise_utils-0.0.4.tar.gz` & `tmp/ausbildungsnachweise_utils-0.0.5.tar.gz`
...
## Comparing `ausbildungsnachweise_utils-0.0.4.tar` & `ausbildungsnachweise_utils-0.0.5.tar`
...
### Comparing `ausbildungsnachweise_utils-0.0.4/ausbildungsnachweise_utils/processor.py` & `ausbildungsnachweise_utils-0.0.5/ausbildungsnachweise_utils/processor.py`

 * *Files identical despite different names*

### Comparing `ausbildungsnachweise_utils-0.0.4/setup.py` & `ausbildungsnachweise_utils-0.0.5/setup.py`
