# Comparing `tmp/ersciyt-1.3.tar.gz` & `tmp/ersciyt-1.4.tar.gz`
...
## Comparing `ersciyt-1.3.tar` & `ersciyt-1.4.tar`
...
### Comparing `ersciyt-1.3/LICENSE` & `ersciyt-1.4/LICENSE`

 * *Files identical despite different names*

### Comparing `ersciyt-1.3/PKG-INFO` & `ersciyt-1.4/PKG-INFO`
...
### Comparing `ersciyt-1.3/README.md` & `ersciyt-1.4/README.md`

 * *Files identical despite different names*

### Comparing `ersciyt-1.3/ersciyt/views.py` & `ersciyt-1.4/ersciyt/views.py`
...
### Comparing `ersciyt-1.3/ersciyt.egg-info/PKG-INFO` & `ersciyt-1.4/ersciyt.egg-info/PKG-INFO`
...
### Comparing `ersciyt-1.3/setup.cfg` & `ersciyt-1.4/setup.cfg`
