# Comparing `tmp/tarvis-tradingbot-0.9.3.tar.gz` & `tmp/tarvis-tradingbot-0.9.4.tar.gz`
...
## Comparing `tarvis-tradingbot-0.9.3.tar` & `tarvis-tradingbot-0.9.4.tar`
...
### Comparing `tarvis-tradingbot-0.9.3/LICENSE.txt` & `tarvis-tradingbot-0.9.4/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `tarvis-tradingbot-0.9.3/setup.py` & `tarvis-tradingbot-0.9.4/setup.py`
...
### Comparing `tarvis-tradingbot-0.9.3/tarvis/tradingbot/__init__.py` & `tarvis-tradingbot-0.9.4/tarvis/tradingbot/__init__.py`
