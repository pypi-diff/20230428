# Comparing `tmp/tarvis-indicators-webapi-0.9.3.tar.gz` & `tmp/tarvis-indicators-webapi-0.9.4.tar.gz`
...
## Comparing `tarvis-indicators-webapi-0.9.3.tar` & `tarvis-indicators-webapi-0.9.4.tar`
...
### Comparing `tarvis-indicators-webapi-0.9.3/LICENSE.txt` & `tarvis-indicators-webapi-0.9.4/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `tarvis-indicators-webapi-0.9.3/setup.py` & `tarvis-indicators-webapi-0.9.4/setup.py`
...
### Comparing `tarvis-indicators-webapi-0.9.3/tarvis/indicators/webapi/__init__.py` & `tarvis-indicators-webapi-0.9.4/tarvis/indicators/webapi/__init__.py`
