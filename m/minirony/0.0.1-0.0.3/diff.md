# Comparing `tmp/Minirony-0.0.1.tar.gz` & `tmp/minirony-0.0.3.tar.gz`
...
+gzip compressed data, was "minirony-0.0.3.tar", last modified: Fri Apr 28 19:47:10 2023, max compression
```

## Comparing `Minirony-0.0.1.tar` & `minirony-0.0.3.tar`
...
+drwxr-xr-x   0 zagnoli   (1000) zagnoli   (1000)        0 2023-04-28 19:47:10.569962 minirony-0.0.3/
+-rw-r--r--   0 zagnoli   (1000) zagnoli   (1000)      100 2023-04-28 19:47:10.569962 minirony-0.0.3/PKG-INFO
+drwxr-xr-x   0 zagnoli   (1000) zagnoli   (1000)        0 2023-04-28 19:47:10.569962 minirony-0.0.3/minirony/
+-rw-r--r--   0 zagnoli   (1000) zagnoli   (1000)       41 2023-04-28 19:46:41.000000 minirony-0.0.3/minirony/__init__.py
+-rw-r--r--   0 zagnoli   (1000) zagnoli   (1000)      178 2023-04-25 19:39:48.000000 minirony-0.0.3/minirony/data_transfer.py
+-rw-r--r--   0 zagnoli   (1000) zagnoli   (1000)     1384 2023-04-25 19:39:48.000000 minirony-0.0.3/minirony/factory.py
+-rw-r--r--   0 zagnoli   (1000) zagnoli   (1000)     3542 2023-04-25 19:39:48.000000 minirony-0.0.3/minirony/helper.py
+-rw-r--r--   0 zagnoli   (1000) zagnoli   (1000)     9630 2023-04-28 19:46:42.000000 minirony-0.0.3/minirony/manager.py
+-rw-r--r--   0 zagnoli   (1000) zagnoli   (1000)     1882 2023-04-25 19:39:48.000000 minirony-0.0.3/minirony/provider.py
+drwxr-xr-x   0 zagnoli   (1000) zagnoli   (1000)        0 2023-04-28 19:47:10.569962 minirony-0.0.3/minirony.egg-info/
+-rw-r--r--   0 zagnoli   (1000) zagnoli   (1000)      100 2023-04-28 19:47:10.000000 minirony-0.0.3/minirony.egg-info/PKG-INFO
+-rw-r--r--   0 zagnoli   (1000) zagnoli   (1000)      263 2023-04-28 19:47:10.000000 minirony-0.0.3/minirony.egg-info/SOURCES.txt
+-rw-r--r--   0 zagnoli   (1000) zagnoli   (1000)        1 2023-04-28 19:47:10.000000 minirony-0.0.3/minirony.egg-info/dependency_links.txt
+-rw-r--r--   0 zagnoli   (1000) zagnoli   (1000)        9 2023-04-28 19:47:10.000000 minirony-0.0.3/minirony.egg-info/top_level.txt
+-rw-r--r--   0 zagnoli   (1000) zagnoli   (1000)       38 2023-04-28 19:47:10.569962 minirony-0.0.3/setup.cfg
+-rw-r--r--   0 zagnoli   (1000) zagnoli   (1000)      171 2023-04-28 19:46:41.000000 minirony-0.0.3/setup.py
```

### Comparing `Minirony-0.0.1/minirony/factory.py` & `minirony-0.0.3/minirony/factory.py`

 * *Files identical despite different names*

### Comparing `Minirony-0.0.1/minirony/helper.py` & `minirony-0.0.3/minirony/helper.py`

 * *Files identical despite different names*

### Comparing `Minirony-0.0.1/minirony/manager.py` & `minirony-0.0.3/minirony/manager.py`
...
### Comparing `Minirony-0.0.1/minirony/provider.py` & `minirony-0.0.3/minirony/provider.py`
