# Comparing `tmp/kegstandcli-0.3.2.tar.gz` & `tmp/kegstandcli-0.3.3.tar.gz`
...
## Comparing `kegstandcli-0.3.2.tar` & `kegstandcli-0.3.3.tar`
...
### Comparing `kegstandcli-0.3.2/LICENSE` & `kegstandcli-0.3.3/LICENSE`

 * *Files identical despite different names*

### Comparing `kegstandcli-0.3.2/README.md` & `kegstandcli-0.3.3/README.md`
...
+       Created by Jens_Roland and fueled by a non-zero amount of alcohol
                              Watch_a_3-minute_demo
 
 ## ð¥ððº Welcome to the Party! ð¥ððº Kegstand is a free and open-
 source framework for creating Python APIs and services. It allows you to
 rapidly build and deploy services on AWS. We all have better things to do than
 `print(json.dumps(event))` all day long, and Kegstand is here to help you get
 to the party — _and into Prod_ — a lot faster. **It provides:** - A CLI tool
```

### Comparing `kegstandcli-0.3.2/pyproject.toml` & `kegstandcli-0.3.3/pyproject.toml`
...
### Comparing `kegstandcli-0.3.2/src/kegstandcli/cli/__main__.py` & `kegstandcli-0.3.3/src/kegstandcli/cli/__main__.py`

 * *Files identical despite different names*

### Comparing `kegstandcli-0.3.2/src/kegstandcli/cli/build.py` & `kegstandcli-0.3.3/src/kegstandcli/cli/build.py`

 * *Files identical despite different names*

### Comparing `kegstandcli-0.3.2/src/kegstandcli/cli/config.py` & `kegstandcli-0.3.3/src/kegstandcli/cli/config.py`

 * *Files identical despite different names*

### Comparing `kegstandcli-0.3.2/src/kegstandcli/cli/deploy.py` & `kegstandcli-0.3.3/src/kegstandcli/cli/deploy.py`

 * *Files identical despite different names*

### Comparing `kegstandcli-0.3.2/src/kegstandcli/cli/new.py` & `kegstandcli-0.3.3/src/kegstandcli/cli/new.py`

 * *Files identical despite different names*

### Comparing `kegstandcli-0.3.2/src/kegstandcli/cli/teardown.py` & `kegstandcli-0.3.3/src/kegstandcli/cli/teardown.py`

 * *Files identical despite different names*

### Comparing `kegstandcli-0.3.2/src/kegstandcli/infra/app.py` & `kegstandcli-0.3.3/src/kegstandcli/infra/app.py`

 * *Files identical despite different names*

### Comparing `kegstandcli-0.3.2/src/kegstandcli/infra/stacks/lambda_rest_api.py` & `kegstandcli-0.3.3/src/kegstandcli/infra/stacks/lambda_rest_api.py`

 * *Files identical despite different names*

### Comparing `kegstandcli-0.3.2/src/kegstandcli/utils.py` & `kegstandcli-0.3.3/src/kegstandcli/utils.py`

 * *Files identical despite different names*

### Comparing `kegstandcli-0.3.2/setup.py` & `kegstandcli-0.3.3/setup.py`
...
+       Created by Jens_Roland and fueled by a non-zero amount of alcohol
 \n
                              Watch_a_3-minute_demo
 \n\n
 \n\n## ð¥ððº Welcome to the Party! ð¥ððº\n\nKegstand is a free
 and open-source framework for creating Python APIs and services. It allows you
 to rapidly build and deploy services on AWS. We all have better things to do
 than `print(json.dumps(event))` all day long, and Kegstand is here to help you
```

### Comparing `kegstandcli-0.3.2/PKG-INFO` & `kegstandcli-0.3.3/PKG-INFO`
