# Comparing `tmp/python_roborock-0.8.2.tar.gz` & `tmp/python_roborock-0.8.3.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "python_roborock-0.8.2.tar", max compression
+gzip compressed data, was "python_roborock-0.8.3.tar", max compression
```

## Comparing `python_roborock-0.8.2.tar` & `python_roborock-0.8.3.tar`

### file list

```diff
@@ -1,17 +1,17 @@
--rw-r--r--   0        0        0    35149 2023-04-27 16:10:19.652075 python_roborock-0.8.2/LICENSE
--rw-r--r--   0        0        0     2122 2023-04-27 16:10:19.652075 python_roborock-0.8.2/README.md
--rw-r--r--   0        0        0     1370 2023-04-27 16:10:20.728084 python_roborock-0.8.2/pyproject.toml
--rw-r--r--   0        0        0      156 2023-04-27 16:10:19.652075 python_roborock-0.8.2/roborock/__init__.py
--rw-r--r--   0        0        0    20474 2023-04-27 16:10:19.652075 python_roborock-0.8.2/roborock/api.py
--rw-r--r--   0        0        0     4102 2023-04-27 16:10:19.652075 python_roborock-0.8.2/roborock/cli.py
--rw-r--r--   0        0        0     7541 2023-04-27 16:10:19.652075 python_roborock-0.8.2/roborock/cloud_api.py
--rw-r--r--   0        0        0     4329 2023-04-27 16:10:19.652075 python_roborock-0.8.2/roborock/code_mappings.py
--rw-r--r--   0        0        0      209 2023-04-27 16:10:19.652075 python_roborock-0.8.2/roborock/const.py
--rw-r--r--   0        0        0    10730 2023-04-27 16:10:19.652075 python_roborock-0.8.2/roborock/containers.py
--rw-r--r--   0        0        0     1483 2023-04-27 16:10:19.652075 python_roborock-0.8.2/roborock/exceptions.py
--rw-r--r--   0        0        0     5366 2023-04-27 16:10:19.652075 python_roborock-0.8.2/roborock/local_api.py
--rw-r--r--   0        0        0      694 2023-04-27 16:10:19.652075 python_roborock-0.8.2/roborock/roborock_future.py
--rw-r--r--   0        0        0     6232 2023-04-27 16:10:19.652075 python_roborock-0.8.2/roborock/roborock_message.py
--rw-r--r--   0        0        0    12651 2023-04-27 16:10:19.652075 python_roborock-0.8.2/roborock/typing.py
--rw-r--r--   0        0        0      783 2023-04-27 16:10:19.652075 python_roborock-0.8.2/roborock/util.py
--rw-r--r--   0        0        0     3339 1970-01-01 00:00:00.000000 python_roborock-0.8.2/PKG-INFO
...
### Comparing `python_roborock-0.8.2/LICENSE` & `python_roborock-0.8.3/LICENSE`

 * *Files identical despite different names*

### Comparing `python_roborock-0.8.2/README.md` & `python_roborock-0.8.3/README.md`

 * *Files identical despite different names*

### Comparing `python_roborock-0.8.2/pyproject.toml` & `python_roborock-0.8.3/pyproject.toml`
...
### Comparing `python_roborock-0.8.2/roborock/api.py` & `python_roborock-0.8.3/roborock/api.py`
...
### Comparing `python_roborock-0.8.2/roborock/cli.py` & `python_roborock-0.8.3/roborock/cli.py`
...
### Comparing `python_roborock-0.8.2/roborock/cloud_api.py` & `python_roborock-0.8.3/roborock/cloud_api.py`
...
### Comparing `python_roborock-0.8.2/roborock/code_mappings.py` & `python_roborock-0.8.3/roborock/code_mappings.py`
...
### Comparing `python_roborock-0.8.2/roborock/containers.py` & `python_roborock-0.8.3/roborock/containers.py`

 * *Files identical despite different names*

### Comparing `python_roborock-0.8.2/roborock/exceptions.py` & `python_roborock-0.8.3/roborock/exceptions.py`

 * *Files identical despite different names*

### Comparing `python_roborock-0.8.2/roborock/local_api.py` & `python_roborock-0.8.3/roborock/local_api.py`
...
### Comparing `python_roborock-0.8.2/roborock/roborock_future.py` & `python_roborock-0.8.3/roborock/roborock_future.py`

 * *Files identical despite different names*

### Comparing `python_roborock-0.8.2/roborock/roborock_message.py` & `python_roborock-0.8.3/roborock/roborock_message.py`

 * *Files identical despite different names*

### Comparing `python_roborock-0.8.2/roborock/typing.py` & `python_roborock-0.8.3/roborock/typing.py`

 * *Files identical despite different names*

### Comparing `python_roborock-0.8.2/roborock/util.py` & `python_roborock-0.8.3/roborock/util.py`

 * *Files identical despite different names*

### Comparing `python_roborock-0.8.2/PKG-INFO` & `python_roborock-0.8.3/PKG-INFO`
...
```diff
@@ -1,8 +1,8 @@
-Metadata-Version: 2.1 Name: python-roborock Version: 0.8.2 Summary: A package
