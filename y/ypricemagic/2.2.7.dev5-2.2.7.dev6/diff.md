# Comparing `tmp/ypricemagic-2.2.7.dev5.tar.gz` & `tmp/ypricemagic-2.2.7.dev6.tar.gz`
...
### Comparing `ypricemagic-2.2.7.dev5/tests/classes/test_singleton.py` & `ypricemagic-2.2.7.dev6/tests/classes/test_singleton.py`
