# Comparing `tmp/utterless-0.3.0.tar.gz` & `tmp/utterless-0.3.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "utterless-0.3.0.tar", last modified: Mon Mar 13 22:21:53 2023, max compression
+gzip compressed data, was "utterless-0.3.1.tar", last modified: Fri Apr 28 15:32:36 2023, max compression
```

## Comparing `utterless-0.3.0.tar` & `utterless-0.3.1.tar`

### file list

```diff
@@ -1,18 +1,18 @@
-drwxrwxr-x   0 psc       (1000) psc       (1000)        0 2023-03-13 22:21:53.329759 utterless-0.3.0/
--rw-rw-r--   0 psc       (1000) psc       (1000)     3763 2023-03-13 22:21:53.329759 utterless-0.3.0/PKG-INFO
--rw-rw-r--   0 psc       (1000) psc       (1000)     2251 2023-03-07 23:44:52.000000 utterless-0.3.0/README.md
--rw-rw-r--   0 psc       (1000) psc       (1000)      966 2023-03-13 22:21:53.329759 utterless-0.3.0/setup.cfg
--rw-rw-r--   0 psc       (1000) psc       (1000)      161 2023-01-20 22:41:33.000000 utterless-0.3.0/setup.py
-drwxrwxr-x   0 psc       (1000) psc       (1000)        0 2023-03-13 22:21:53.329759 utterless-0.3.0/utterless/
--rw-rw-r--   0 psc       (1000) psc       (1000)      113 2023-03-13 22:20:15.000000 utterless-0.3.0/utterless/__init__.py
--rw-rw-r--   0 psc       (1000) psc       (1000)      386 2023-02-05 14:12:40.000000 utterless-0.3.0/utterless/__main__.py
-drwxrwxr-x   0 psc       (1000) psc       (1000)        0 2023-03-13 22:21:53.329759 utterless-0.3.0/utterless/contrib/
--rw-rw-r--   0 psc       (1000) psc       (1000)        0 2023-02-05 14:12:40.000000 utterless-0.3.0/utterless/contrib/__init__.py
--rw-rw-r--   0 psc       (1000) psc       (1000)      280 2023-02-05 14:12:40.000000 utterless-0.3.0/utterless/contrib/django.py
--rw-rw-r--   0 psc       (1000) psc       (1000)     1419 2023-03-07 23:57:00.000000 utterless-0.3.0/utterless/results.py
--rw-rw-r--   0 psc       (1000) psc       (1000)      280 2023-02-05 14:12:40.000000 utterless-0.3.0/utterless/runner.py
-drwxrwxr-x   0 psc       (1000) psc       (1000)        0 2023-03-13 22:21:53.329759 utterless-0.3.0/utterless.egg-info/
--rw-rw-r--   0 psc       (1000) psc       (1000)     3763 2023-03-13 22:21:53.000000 utterless-0.3.0/utterless.egg-info/PKG-INFO
--rw-rw-r--   0 psc       (1000) psc       (1000)      303 2023-03-13 22:21:53.000000 utterless-0.3.0/utterless.egg-info/SOURCES.txt
--rw-rw-r--   0 psc       (1000) psc       (1000)        1 2023-03-13 22:21:53.000000 utterless-0.3.0/utterless.egg-info/dependency_links.txt
--rw-rw-r--   0 psc       (1000) psc       (1000)       10 2023-03-13 22:21:53.000000 utterless-0.3.0/utterless.egg-info/top_level.txt
...
### Comparing `utterless-0.3.0/PKG-INFO` & `utterless-0.3.1/PKG-INFO`
...
### Comparing `utterless-0.3.0/README.md` & `utterless-0.3.1/README.md`

 * *Files identical despite different names*

### Comparing `utterless-0.3.0/setup.cfg` & `utterless-0.3.1/setup.cfg`

 * *Files identical despite different names*

### Comparing `utterless-0.3.0/utterless/results.py` & `utterless-0.3.1/utterless/results.py`
...
### Comparing `utterless-0.3.0/utterless.egg-info/PKG-INFO` & `utterless-0.3.1/utterless.egg-info/PKG-INFO`
